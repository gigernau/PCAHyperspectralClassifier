...
double* fit_transform(int M, int N, double *R, bool verbose);
...
float* fit_transform(int M, int N, float *R, bool verbose);

float* fit_transform(int M, int N, std::vector<float> R, bool verbose);
double* fit_transform(int M, int N, std::vector<double> R, bool verbose);
